...
- **Modern Standards**: Adhere to modern C++20, Vulkan 1.4 best practices and rendering industry standards (RAII, zero-overhead abstractions and explicit synchronization). Exceptions are disabled globally across the project; do not use `noexcept` annotations.
